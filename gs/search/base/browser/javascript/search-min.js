"use strict";jQuery.noConflict();function GSSearch(e,P,E,s,N,o){var z=null,f=null,y=null,p=null,q=null,m=null,J=null,r=null,M=null,c=null,t="",G="",L=true,w=false,A="slow",g="swing",i="resultsloaded";
...
Q=jQuery.Event(i);z.trigger(Q)}function l(){var Q=null;Q=q.find(".gs-search-keyword");
if(Q.length>0){Q.removeAttr("href").css("cursor","pointer");Q.click(n)}}function n(Q){var R=jQuery(this).text();
f.val(R);y.click()}function K(){z=jQuery(e);f=z.find(".gs-search-entry input");F();
y=z.find(".gs-search-entry button");H();p=z.find(".gs-search-loading");q=z.find(".gs-search-results");
m=z.find(".gs-search-toolbar");J=z.find(".gs-search-toolbar-previous");C();r=z.find(".gs-search-toolbar-next");
b();c=z.find(".gs-search-empty");c.hide();M=z.find(".gs-search-failed");M.hide();
t=P}K();return{load:function(){y.click()},results_shown:function(){return w},RESULTS_LOADED_EVENT:i}
};